        ...
        <div id="all">
          <div class="info">
            <div class="info-box">
              ...
              <div class="right-div">
                <span>{{personInfoData.login_username}}</span>
              </div>
            </div>
            <br>
            <div class="info-box">
            ...
            <div class="info-box">
              ...
              <div class="right-div">
                <el-tag effect="dark" type="success" v-if="personInfoData.user_level === 1">用户</el-tag>
                <el-tag effect="dark" type="warning" v-else-if="personInfoData.user_level === 2">管理员</el-tag>
              </div>
            </div>
          </div>
          <br>
          <div>
            <el-button size="large" @click.native="handleUpdate()" v-if="showBtn">
              更新
            </el-button>
            <el-button size="large" @click.native="handleCancle()" v-if="showBtn">
              取消
            </el-button>

            <el-button size="large" @click.native="handleEdit()" v-if="!showBtn">
              编辑
            </el-button>
          </div>
        </div>
