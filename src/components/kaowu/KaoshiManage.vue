...
<!--          左对齐按钮-->
      ...
      <div class="right-items" style="float: right;">
        ...
        <el-popover
          ...
          <div style="text-align: center; margin: 0">
            <div style="float: top">
              <el-checkbox-group v-model="checkboxGroup1" size="small" :min="1" :max="23">
                <div style="width: 200px;float: left">
                  <el-checkbox checked v-model="checked1" label="考试时间" border></el-checkbox>
                  <el-checkbox checked v-model="checked2" label="考试编号" border></el-checkbox>
                  <el-checkbox checked v-model="checked3" label="学校名称" border></el-checkbox>
                  <el-checkbox checked v-model="checked4" label="考试名称" border></el-checkbox>
                  <el-checkbox checked v-model="checked5" label="科目名称" border></el-checkbox>
                  <el-checkbox checked v-model="checked6" label="考试场次" border></el-checkbox>
                  <el-checkbox checked v-model="checked7" label="主管教师" border></el-checkbox>
                  <el-checkbox checked v-model="checked8" label="参与教师" border></el-checkbox>
                  <el-checkbox checked v-model="checked9" label="考试人数" border></el-checkbox>
                  <el-checkbox checked v-model="checked10" label="学生名单" border></el-checkbox>
                  <el-checkbox checked v-model="checked11" label="考试报名" border></el-checkbox>
                  <el-checkbox checked v-model="checked12" label="考试题目" border></el-checkbox>
                </div>
                <div style="width: 200px;float: right">
                  <el-checkbox checked v-model="checked13" label="考试题型" border></el-checkbox>
                  <el-checkbox checked v-model="checked14" label="考试试卷" border></el-checkbox>
                  <el-checkbox checked v-model="checked15" label="点阵笔" border></el-checkbox>
                  <el-checkbox checked v-model="checked16" label="点阵纸" border></el-checkbox>
                  <el-checkbox checked v-model="checked17" label="考场准备" border></el-checkbox>
                  <el-checkbox checked v-model="checked18" label="考试状态" border></el-checkbox>
                  <el-checkbox checked v-model="checked19" label="备注" border></el-checkbox>
                  <el-checkbox checked v-model="checked20" label="创建人" border></el-checkbox>
                  <el-checkbox checked v-model="checked21" label="创建时间" border></el-checkbox>
                  <el-checkbox checked v-model="checked22" label="修改人" border></el-checkbox>
                  <el-checkbox checked v-model="checked23" label="修改时间" border></el-checkbox>
                </div>
              </el-checkbox-group>
            </div>
          ...
          <el-button icon="el-icon-s-tools" slot="reference">表格列筛选</el-button>
        </el-popover>
      </div>
    </el-tabs>
    ...
    >
      ...
      <el-table-column v-if="colData[0].istrue" align="center" prop="kaoshi_shijian" label="考试时间" width="auto">
      ...
      <el-table-column align="center" prop="kaoshi_zhuangtai" label="考试状态" width="auto">
        <template slot-scope="{row,$index}">
          ...
          <span v-if="!showSelect[$index]">
            ...
            <el-tag type="info" v-else-if="row.kaoshi_zhuangtai === -10">已取消</el-tag>
            <el-tag type="info" v-else-if="row.kaoshi_zhuangtai === -20">已终止</el-tag>
            <el-tag type="success" v-else-if="row.kaoshi_zhuangtai === 10">筹备中</el-tag>
            <el-tag type="success" v-else-if="row.kaoshi_zhuangtai === 20">正在报名</el-tag>
            <el-tag type="success" v-else-if="row.kaoshi_zhuangtai === 30">已发布</el-tag>
            <el-tag type="danger" v-else-if="row.kaoshi_zhuangtai === 100">正在考试</el-tag>
            <el-tag type="danger" v-else-if="row.kaoshi_zhuangtai === 110">阅卷中</el-tag>
            <el-tag type="danger" v-else-if="row.kaoshi_zhuangtai === 120">成绩发布</el-tag>
    ...
    methods: {
        ...
        this.$refs.insertKaoshiFormRef.validate((valid) => {
          if (valid) {
            var params = qs.stringify({
              ...
              //从sessionStorage取用户名传入后端
              kaoshi_chuangjianren: sessionStorage.getItem("user_name"),
      ...
      handleUpdate(row) {
        var params = qs.stringify({
          ...
          //从sessionStorage取用户名传入后端
          kaoshi_xiugairen: sessionStorage.getItem("user_name"),
          xueqi_id: window.getXueqi_id//当前标签页的学期id
        })
